...
class _SafeScreenState extends State<SafeScreen> {
  ...
  getData() async {
    print(await RepositoryProvider.of<MyDatabase>(context).getData());
  }
            ...
            child:
              ...
              Column(
                  ...
                  children: [
                    ...
                    const Text('take a picture only of you are authorized',
            ...
            child: MaterialButton(
                ...
                onPressed: () {
                  if (productValue != null &&
                    ...
                    if (isWithData) {
                      RepositoryProvider.of<MyDatabase>(context).updateData(
                          SafeTableData(
                              id: id ?? 0,
                      ...
                      RepositoryProvider.of<MyDatabase>(context).insertData(
                          SafeTableData(
                              project: productValue ?? "",
                              category: categoryValue ?? "",
                              rule: savingRuleValue ?? "",
